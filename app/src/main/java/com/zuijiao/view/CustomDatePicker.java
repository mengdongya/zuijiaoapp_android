...
public class CustomDatePicker extends DatePicker {
    ...
    public CustomDatePicker(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            selectionDividerField.set(monthNumberPicker, getResources().getDrawable(R.drawable.bg_gray));
            selectionDividerField.set(dayNumberPicker, getResources().getDrawable(R.drawable.bg_gray));
            selectionDividerField.set(yearNumberPicker, getResources().getDrawable(R.drawable.bg_gray));
