...
public class RefreshAndInitListView extends ListView implements
     ...
     * @param context
     */
    public RefreshAndInitListView(Context context) {
        super(context);
        initWithContext(context);
        this.context = context;
    }

    public RefreshAndInitListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
        this.context = context;
    }
    ...
    public class XListViewFooter extends LinearLayout {
        ...
        public void setState(int state) {
            ...
            if (state == STATE_READY) {
                ...
                mHintView.setText(R.string.list_footer_hint_ready);
            } else if (state == STATE_LOADING) {
                mProgressBar.setVisibility(View.VISIBLE);
            } else {
                mHintView.setVisibility(View.VISIBLE);
                mHintView.setText(R.string.list_footer_hint_normal);
            }
        }
        ...
        public void setState(int state) {
            ...
            switch (state) {
                case STATE_NORMAL:
                    ...
                    mHintTextView.setText(R.string.list_header_hint_normal);
                    break;
                case STATE_READY:
                    if (mState != STATE_READY) {
                        mArrowImageView.clearAnimation();
                        mArrowImageView.startAnimation(mRotateUpAnim);
                        mHintTextView.setText(R.string.list_header_hint_ready);
                    }
                    break;
                case STATE_REFRESHING:
                    mHintTextView.setText(R.string.list_header_hint_loading);
                    break;
                default:
            }
